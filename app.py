...
def transcribe():
    ...
    # Creazione di un file temporaneo per l'audio
    ...
    try:
        ...
        # 2. Configurazione della trascrizione (Semplice per evitare errori 500)
        json_body = {
            'audio_url': audio_url,
            'language_code': 'it',
            'speaker_labels': True,
            'summarization': False  # Disabilitato per stabilità in italiano
        }
        ...
        # 3. Polling: attendiamo il completamento
        while True:
        ...
        if text:
            # Creazione Riassunto: prime 3 frasi
            ...
            # Creazione Mappa Concettuale: frasi chiave medie
        ...
        return jsonify({
            ...
            'summary': summary or "Testo troppo breve per un riassunto.",
        ...
        # Pulizia: eliminiamo il file temporaneo
